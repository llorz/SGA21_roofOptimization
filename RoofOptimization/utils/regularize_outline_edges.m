...
function [obj_new, edges_group, fixed_degrees] = regularize_outline_edges(obj,para)
if nargin < 2
    para.eps_ortho = 1e-3;
    eps_degree = obj.eps_degree;
else
    eps_degree = para.eps_degree;
end

[edges_group, ~ , fixed_degrees] = category_outline_edges(obj,  eps_degree);
