function [X1, X_ini] = construct_3D_roof_tulou(V_all, F, vid_xy, vid_z, lambda, X_ini)
...
% we also penalize the variance of the height of the roof vertices
fval = fval1 + lambda*fval2 + var(X(vid_z,3));
end
